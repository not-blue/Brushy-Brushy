advancement revoke @s only brushy:brush_sheep
...
execute as @e[type=minecraft:interaction,tag=brushy.sheep,nbt={interaction:{}},distance=..5] at @s run loot spawn ~ ~ ~ loot brushy:brush_sheep
